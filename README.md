...
There are now two lists maintained. The "normal" one, excluding cinsarmy and firehol_l2 (ca. 20k entries). And another one with suffix "\_l", including everything (ca. 30k entries).
